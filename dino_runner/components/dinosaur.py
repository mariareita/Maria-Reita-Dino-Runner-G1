...
import pygame
from dino_runner.utils.constants import CAKE_TYPE, DEFAULT_TYPE, DUCKING, DUCKING_CAKE, DUCKING_HAMMER, DUCKING_SHIELD, HAMMER_TYPE, JUMPING, JUMPING_CAKE, JUMPING_HAMMER, JUMPING_SHIELD, RUNNING, RUNNING_CAKE, RUNNING_HAMMER, RUNNING_SHIELD, SHIELD_TYPE
...
class Dinosaur(Sprite):
    ...
    def __init__(self):
        ...
        self.img_run = {DEFAULT_TYPE: RUNNING, SHIELD_TYPE: RUNNING_SHIELD, HAMMER_TYPE: RUNNING_HAMMER, CAKE_TYPE: RUNNING_CAKE}
        self.img_duck = {DEFAULT_TYPE: DUCKING, SHIELD_TYPE: DUCKING_SHIELD, HAMMER_TYPE: DUCKING_HAMMER, CAKE_TYPE: DUCKING_CAKE}
        self.img_jump = {DEFAULT_TYPE: JUMPING, SHIELD_TYPE: JUMPING_SHIELD, HAMMER_TYPE: JUMPING_HAMMER, CAKE_TYPE: JUMPING_CAKE}
